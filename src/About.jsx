...
function About (){
    ...
    return(
        <>
            ...
            <p className="desc about bg-yellow-400 opacity-90 leading-loose mt-[10px] px-[20px]">
            ...
            <div className="Gallery my-[10px] flex flex-row justify-center items-center content-center">
                <div className="arrow1 text-white cursor-pointer mr-[10px] bg-[rgba(0,0,0,0.9)] rounded p-[5px] "><a class="prev" onClick={handlePreviousClick}><h1>&#10094;</h1></a></div>
                <img className="w-[70%] rounded bg-red-500 border-red-500 border-solid "src={card.src}/>
                <div className="arrow2  text-white cursor-pointer ml-[10px] bg-[rgba(0,0,0,0.9)] rounded p-[5px] "><a class="next" onClick={handleNextClick}><h1>&#10095;</h1></a></div>
             </div>
